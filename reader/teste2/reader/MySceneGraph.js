...
MySceneGraph.prototype.parseAnimations = function(rootElement){
    ...
    for(var i = 0; i < size; i++){
        ...
        if(type == "linear"){
			var angle = this.reader.getFloat(e,"rot",true);
			angle = this.deg2rad(angle);
            var control_points = [];
            for(var j = 0; j<e.children.length; j++){
            ...
            this.animations.push(new LinearAnimation(id, time, control_points, angle));
        }
...
MySceneGraph.prototype.readPrimitives = function (e, j, obj, all_ids){
	...
	switch(e.children[j].nodeName){
        ...
        case "chessboard":
            ...
            break;
		case "mari":
            this.mari[obj.size_m] = [];
            this.mari[obj.size_m][0] = id;
            obj.size_m+=1;
            break;
...
MySceneGraph.prototype.parsePrimitives = function(rootElement){
	...
	var obj = {
		size_r : 0, size_t : 0, size_c : 0, size_s : 0, size_d : 0, size_p : 0, size_patch : 0, size_v : 0, size_chess : 0, size_m : 0
	};
                            ...
                            if((bananas = this.isPrimitive(objects[6], id, vertex, "pat")) == null)
                                if((bananas = this.isPrimitive(objects[7], id, vertex, "car")) == null)
                                    if((bananas = this.isPrimitive(objects[8], id, vertex, "chess")) == null)
                                        if((bananas = this.isPrimitive(objects[9], id, vertex, "mari")) == null)
...
MySceneGraph.prototype.parseComponents = function(rootElement){
    ...
    objects.push(this.planes); objects.push(this.patches); objects.push(this.vehicles); objects.push(this.chesses); objects.push(this.mari);
